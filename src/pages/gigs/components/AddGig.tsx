...
import { AddGigWrapper, List } from '../styles'
    ...
    <AddGigWrapper>
      ...
      <Grid container spacing={4}>
        <Grid item xs={12} sm={3}>
          ...
          >
            <List
              active={sector === 'basic_data'}
              onClick={() => setSector('basic_data')}
            >
              <a href="#!">Basic Data</a>
            </List>
            <List
              active={sector === 'remuneration'}
              onClick={() => setSector('remuneration')}
            >
              <a href="#!">Remuneration</a>
            </List>
          </Paper>
        </Grid>
        <Grid item xs={12} sm={6}>
          ...
          >
            {sector === 'basic_data' ? (
                    ...
                    <Grid item xs={12} sm={6}>
                      ...
                      <FormControl className="custom-input">
                        <Select
                          ...
                          value={value}
                          onChange={(
                            e: ChangeEvent<{ value: unknown | string }>
              ...
              <>
                <Box component="form" margin={1} marginBottom={10}>
                  <p style={{ color: 'rgba(86, 93, 116,0.7)' }}>Salary</p>
                  <Grid container spacing={2}>
                    <Grid item xs={12} sm={6}>
                      <OutlinedInput
                        className="custom-input"
